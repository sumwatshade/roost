        ...
        <Box component={Paper} p={3} mt={3}>
          ...
          <Box my={2}>
            <Typography variant="body1" color="secondary">
              ...
              employ) have in particular suffered immediately. As a lovely and
              empathetic community, I am reaching out to my fellow San Diegans
              ...
              <ul>
                ...
                <li>
                  <WebsiteLink
                    ...
                    href="https://www.reddit.com/live/14d816ty1ylvo/"
                  />
                </li>
                <li>
                  <WebsiteLink
                ...
                <li>
                  Did you test positive? Are you curious of what it&apos;s like?
                  Here is a&nbsp;
                  <WebsiteLink
                  ...
                  />
                  &nbsp;of people describing their experience and symptoms
                </li>
              </ul>
            </Typography>
          </Box>
              ...
              <ul>
                <li>
                  <WebsiteLink
                    ...
                    href="https://www.reddit.com/r/YouShouldKnow/comments/flk9lr/ysk_audible_has_made_hundreds_of_children_ages/"
                  />
                </li>
                <li>
                  Listen to music with your friends with&nbsp;
                  <WebsiteLink
                    label="JQBX"
                    color="primary"
